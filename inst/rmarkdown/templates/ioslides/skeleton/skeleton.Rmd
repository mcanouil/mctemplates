...
csl: '`r system.file("rmarkdown/templates/ioslides/resources/csl/apa.csl", package = "mctemplates")`' 
css: '`r system.file("rmarkdown/templates/ioslides/resources/mc_theme.css", package = "mctemplates")`' 
logo: '`r system.file("rmarkdown/templates/ioslides/resources/logo_UMR.png", package = "mctemplates")`' 
output:
