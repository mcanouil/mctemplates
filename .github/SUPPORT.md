# Getting help with mctemplates

Thanks for using mctemplates. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/mctemplates/issues) to make sure the 
